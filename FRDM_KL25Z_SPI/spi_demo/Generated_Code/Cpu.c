...
void PE_low_level_init(void)
{
  ...
  /* ### BitIO_LDD "Blue_LED" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  (void)Blue_LED_Init(NULL);
  /* ### BitIO_LDD "Green_LED" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  (void)Green_LED_Init(NULL);
  /* ### BitIO_LDD "Red_LED" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  ...
  (void)SM1_Init(NULL);
  /* ### SPISlave_LDD "SS1" component auto initializatation. Auto initialization feature can be disabled by component's property "Auto initialization". */
  (void)SS1_Init(NULL);
  __EI();
}

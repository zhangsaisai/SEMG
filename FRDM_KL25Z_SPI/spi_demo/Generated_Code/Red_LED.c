...
} Red_LED_TDeviceData;                 /* Device data structure type */
...
LDD_TDeviceData* Red_LED_Init(LDD_TUserData *UserDataPtr)
{
  ...
  Red_LED_TDeviceDataPtr DeviceDataPrv;
...
void Red_LED_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  if (Val) {
    GPIO_PDD_SetPortDataOutputMask(Red_LED_MODULE_BASE_ADDRESS, Red_LED_PORT_MASK);
  } else { /* !Val */
    GPIO_PDD_ClearPortDataOutputMask(Red_LED_MODULE_BASE_ADDRESS, Red_LED_PORT_MASK);
  } /* !Val */
}
...
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  GPIO_PDD_TogglePortDataOutputMask(Red_LED_MODULE_BASE_ADDRESS, Red_LED_PORT_MASK);
}

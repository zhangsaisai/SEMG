...
**     Date/Time   : 2015-10-19, 21:52, # CodeGen: 28
**     Abstract    :
**
**     Settings    :
**
...
void PE_low_level_init(void)
{
  ...
  (void)IO1_Init(NULL);
  /* ### SPISlave_LDD "SS0" component auto initializatation. Auto initialization feature can be disabled by component's property "Auto initialization". */
  (void)SS0_Init(NULL);

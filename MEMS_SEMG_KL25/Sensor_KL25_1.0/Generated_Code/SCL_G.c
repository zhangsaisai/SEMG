...
} SCL_G_TDeviceData;                   /* Device data structure type */

typedef SCL_G_TDeviceData *SCL_G_TDeviceDataPtr ; /* Pointer to the device data structure. */

/* {Default RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static SCL_G_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/*
** ===================================================================
...
LDD_TDeviceData* SCL_G_Init(LDD_TUserData *UserDataPtr)
{
  ...
  SCL_G_TDeviceDataPtr DeviceDataPrv;
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_SCL_G_ID,DeviceDataPrv);
...
bool SCL_G_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  PortData = GPIO_PDD_GetPortDataOutput(SCL_G_MODULE_BASE_ADDRESS) & SCL_G_PORT_MASK;
...
void SCL_G_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  if (Val) {
    GPIO_PDD_SetPortDataOutputMask(SCL_G_MODULE_BASE_ADDRESS, SCL_G_PORT_MASK);
  } else { /* !Val */
    GPIO_PDD_ClearPortDataOutputMask(SCL_G_MODULE_BASE_ADDRESS, SCL_G_PORT_MASK);
  } /* !Val */
}

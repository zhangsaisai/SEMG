...
} PTD0_50HZ_TDeviceData;               /* Device data structure type */

typedef PTD0_50HZ_TDeviceData *PTD0_50HZ_TDeviceDataPtr ; /* Pointer to the device data structure. */

/* {Default RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static PTD0_50HZ_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/*
** ===================================================================
...
LDD_TDeviceData* PTD0_50HZ_Init(LDD_TUserData *UserDataPtr)
{
  ...
  PTD0_50HZ_TDeviceDataPtr DeviceDataPrv;
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_PTD0_50HZ_ID,DeviceDataPrv);
...
bool PTD0_50HZ_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  PortData = GPIO_PDD_GetPortDataOutput(PTD0_50HZ_MODULE_BASE_ADDRESS) & PTD0_50HZ_PORT_MASK;
...
void PTD0_50HZ_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  if (Val) {
    GPIO_PDD_SetPortDataOutputMask(PTD0_50HZ_MODULE_BASE_ADDRESS, PTD0_50HZ_PORT_MASK);
  } else { /* !Val */
    GPIO_PDD_ClearPortDataOutputMask(PTD0_50HZ_MODULE_BASE_ADDRESS, PTD0_50HZ_PORT_MASK);
  } /* !Val */
}

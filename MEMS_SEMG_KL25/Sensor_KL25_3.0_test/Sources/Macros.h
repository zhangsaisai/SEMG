...
#define SENSOR_DATA_COUNT 18U//18 bytes                                  /*!< The count of channel data uploaded to ARM each time per ADC. */
#define CHANNEL_DATA_COUNT 5U//5 times                                 /*!< The times of channel data uploaded to ARM */

//#define MCU_NUMBER     0X0BU  /*mems sensor mcu number*/
 ...
 *
   @verbatim
   ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   |0xb8|Branch_Num|channel_package_length_high|channel_package_length_low|expected_frame_high|expected_frame_low|wait_time|status_high|status_low|0x12	| branch_num | data|0xed|
   ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   status_high: [7] - x
                [6] - x
                [5] - x
   ...
   @endverbatim
 */
#define DATA_FRAME_LENGTH 102                                 /*!< The length of a data frame when using 50HZ. */

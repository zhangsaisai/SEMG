...
} BitIO_AD_NOT_CS1_TDeviceData;        /* Device data structure type */

typedef BitIO_AD_NOT_CS1_TDeviceData *BitIO_AD_NOT_CS1_TDeviceDataPtr ; /* Pointer to the device data structure. */

/* {Default RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static BitIO_AD_NOT_CS1_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/*
** ===================================================================
...
LDD_TDeviceData* BitIO_AD_NOT_CS1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  BitIO_AD_NOT_CS1_TDeviceDataPtr DeviceDataPrv;
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_BitIO_AD_NOT_CS1_ID,DeviceDataPrv);
...
bool BitIO_AD_NOT_CS1_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  PortData = GPIO_PDD_GetPortDataOutput(BitIO_AD_NOT_CS1_MODULE_BASE_ADDRESS) & BitIO_AD_NOT_CS1_PORT_MASK;
...
void BitIO_AD_NOT_CS1_PutVal(LDD_TDeviceData *DeviceDataPtr, bool Val)
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  if (Val) {
    GPIO_PDD_SetPortDataOutputMask(BitIO_AD_NOT_CS1_MODULE_BASE_ADDRESS, BitIO_AD_NOT_CS1_PORT_MASK);
  } else { /* !Val */
    GPIO_PDD_ClearPortDataOutputMask(BitIO_AD_NOT_CS1_MODULE_BASE_ADDRESS, BitIO_AD_NOT_CS1_PORT_MASK);
  } /* !Val */
}

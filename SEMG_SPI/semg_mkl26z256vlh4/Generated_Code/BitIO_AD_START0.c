...
} BitIO_AD_START0_TDeviceData;         /* Device data structure type */

typedef BitIO_AD_START0_TDeviceData *BitIO_AD_START0_TDeviceDataPtr ; /* Pointer to the device data structure. */

/* {Default RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static BitIO_AD_START0_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/*
** ===================================================================
...
LDD_TDeviceData* BitIO_AD_START0_Init(LDD_TUserData *UserDataPtr)
{
  ...
  BitIO_AD_START0_TDeviceDataPtr DeviceDataPrv;
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_BitIO_AD_START0_ID,DeviceDataPrv);

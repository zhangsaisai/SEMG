...
} DMAT_S_SPI_RX_TDeviceData;

/* {Default RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static DMAT_S_SPI_RX_TDeviceData DeviceDataPtr__DEFAULT_RTOS_ALLOC;
/* {Default RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
...
LDD_TDeviceData* DMAT_S_SPI_RX_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* Source settings */
  DeviceDataPtr->DescriptorPtr->SourceAddress = (LDD_DMA_TAddress)(&SPI1_DL); /* Address of a DMA transfer source data */
...
{
  return DMA_CTRL_AllocateChannel((LDD_TDeviceData *)(((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DMA_LDD_DeviceDataPtr), ((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DescriptorPtr);
}
...
{
  return DMA_CTRL_EnableChannel((LDD_TDeviceData *)(((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DMA_LDD_DeviceDataPtr), ((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DescriptorPtr);
}
...
{
  return DMA_CTRL_DisableChannel((LDD_TDeviceData *)(((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DMA_LDD_DeviceDataPtr), ((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DescriptorPtr);
}
...
{
  return DMA_CTRL_SetChannelSourceAddress((LDD_TDeviceData *)(((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DMA_LDD_DeviceDataPtr), ((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DescriptorPtr, Address);
}
...
{
  return DMA_CTRL_SetChannelDestinationAddress((LDD_TDeviceData *)(((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DMA_LDD_DeviceDataPtr), ((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DescriptorPtr, Address);
}
...
{
  return DMA_CTRL_SetChannelByteCount((LDD_TDeviceData *)(((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DMA_LDD_DeviceDataPtr), ((DMAT_S_SPI_RX_TDeviceData *)DeviceDataPtr)->DescriptorPtr, ByteCount);
}

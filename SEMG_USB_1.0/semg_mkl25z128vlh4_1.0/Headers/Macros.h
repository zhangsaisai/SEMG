...
extern uint8 MCU_NUMBER;                                 /*!< The number of MCU. */
...
extern const uint8 SPI0_RX_DMA_CHANNEL;
     ...
     * @{
     */
#define   CHANNEL_DATA_COUNT   Period                                /*!< The count of channel data uploaded to ARM each time per ADC. */
/*!
 ...
 *
   ...
   @endverbatim
 */
#define CHANNEL_PACKAGE_LENGTH  (2*Period+3)                            /*!< The length of a channel package. */
...
#define DATA_FRAME_LENGTH 3258                                /*!< The length of a data frame when using 2 ADC. */
...
struct TMCUData
{
    int16 channelData[USING_ADC_COUNT][USING_CHANNEL_COUNT][100];            /*!< The value of every channel's data from ADC. */

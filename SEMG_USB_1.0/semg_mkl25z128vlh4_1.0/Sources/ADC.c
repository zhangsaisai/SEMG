...
#elif TEST_ADC == 1
    regVal[4] = 0x10U;  /* CH1SET, short input */
    regVal[5] = 0x10U;  /* CH2SET, short input */
    regVal[6] = 0x10U;  /* CH3SET, short input */
    regVal[7] = 0x10U;  /* CH4SET, short input */
    regVal[8] = 0x10U;  /* CH5SET, short input */
    regVal[9] = 0x10U;  /* CH6SET, short input */
    regVal[10] = 0x10U; /* CH7SET, short input */
    regVal[11] = 0x10U; /* CH8SET, short input */
#endif

...
USB_CLASS_AUDIO_ENDPOINT_DATA g_audio_endpoint_data;
...
{    
    ...
    switch(setup_packet -> request)
			...
			case SET_Period:
			    ...
			    Period = (uint_16)setup_packet->value;
...
)
{
    ...
    if(MAX_QUEUE_ELEMS != queue_num)//if queue_num==1,there is already a queue,USB is busy 
    {
        /* the bin is not full*/
